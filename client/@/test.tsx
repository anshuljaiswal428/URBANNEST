...
const SignUpOwner: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Sign up owner successful", description: "Your account has been created." });
      ...
      if (error instanceof FirebaseError) {
        ...
        switch (firebaseError.code) {
          case 'auth/email-already-in-use':
            toast({ title: "Sign up failed. Please try again.", description: 'Email already exists!' });
            break;
          case 'auth/invalid-email':
          case 'auth/operation-not-allowed':
          case 'auth/weak-password':
            toast({ title: "Sign up failed. Please try again.", description: firebaseError.message });
            break;
          default:
            toast({ title: "Sign up failed. Please try again.", description: firebaseError.message });
            break;
